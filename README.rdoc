...
1. Add/modify additional checkbox filters to the doSearch() function (maps_lib.js line 74). This will depend on the data you are trying to map. I put in one example of filtering by the 'type' column. *If you don't have any columns to filter with checkboxes, just remove this section of code.* You can see additional examples of these by viewing the source on any of these:
