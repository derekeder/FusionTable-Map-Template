...
1. Use the Chrome <a href='https://developers.google.com/chrome-developer-tools/docs/console'>developer console</a> or install <a href='http://getfirebug.com/'>Firebug</a> for FireFox. This will allow you to debug your javascript.
