...
1. Load your map in the browser and open the javascript console (Chrome on a Mac: option+command+j, Chrome on PC: Control+Shift+J, Firefox: Tools => Web Developer => Firebug => Open Firebug) 
