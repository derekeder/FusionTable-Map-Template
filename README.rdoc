...
<a href='demo/index.html'><img src='/images/map-template-screenshot.png' alt='Searchable map template demo' title='Searchable map template screenshot'/></a>
...
Contact me via email! Derek Eder mailto:derek.eder+git@gmail.com
