...
* geolocation (find me!)
* results count (using Google's visualization API)
...
* Create a Fusion Table (here's a great tutorial: http://support.google.com/fusiontables/bin/answer.py?hl=en&answer=184641)
